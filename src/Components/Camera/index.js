      ...
      <Camera style={styles.camera} type={type} ref={ref}>
        <View style={styles.buttonContainer}>
          <TouchableOpacity
           ...
           <Image style={styles.icon} source={require("../../../assets/f3.png")}/>
          </TouchableOpacity>
          <TouchableOpacity style={styles.buttonTake}
            onPress={take}>
            <Image style={styles.icon} source={require("../../../assets/c1.png")}/>
          </TouchableOpacity>
        </View>
      </Camera>
      <Modal transparent={true} visible={open} >
        <View style={styles.contentPhoto}>
          <View style={styles.contentPhotoButton}>
            ...
            <Image style={styles.icon} source={require("../../../assets/x1.png")}/>
            </TouchableOpacity>
